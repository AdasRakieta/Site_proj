...
setInitialMenuIcons(theme){const iconMap={'menu-icon':'menu_icon','menu-icon-side':'menu_icon','home-icon':'home_icon','lights-icon':'lights_icon','temperature-icon':'temperature_icon','security-icon':'security_icon','settings-icon':'settings_icon','automations-icon':'automations_icon','edit-icon':'edit_icon','user-menu-settings-icon':'settings_icon','user-menu-user-icon':'user_icon'};Object.entries(iconMap).forEach(([id,name])=>{const el=document.getElementById(id);if(el){el.src=`/static/icons/${name}_${theme}.png`;}});}
