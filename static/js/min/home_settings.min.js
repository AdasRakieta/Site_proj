...
showNotification('Lokalizacja domu została zapisana','success');}else{showNotification(result?.error||'Wystąpił błąd podczas aktualizacji lokalizacji','error');}}).catch(error=>{console.error('Error:',error);submitBtn.disabled=false;submitBtn.textContent=originalText;showNotification('Wystąpił błąd podczas aktualizacji lokalizacji','error');});});}
