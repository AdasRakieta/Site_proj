...
public class ApiClient {
    ...
    private void initializeApiService() {
        ...
        if (baseUrl == null || baseUrl.isEmpty()) {
            baseUrl = "http://100.103.184.90:5000/"; // Default URL with VPN IP
        }
    ...
    public String getServerUrl() {
        return preferences.getString(KEY_SERVER_URL, "http://100.103.184.90:5000/");
    }
    ...
    public String[] getFallbackUrls() {
        return new String[]{
            "http://100.103.184.90:5000/",  // Primary VPN IP
