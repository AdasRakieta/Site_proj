#!/usr/bin/env python3
"""
Skrypt uruchamiający serwer Smart Home z gevent
Lepsza wydajność dla środowiska produkcyjnego
"""
import os
import sys
...
def main():
    """Główna funkcja uruchamiająca serwer z gevent"""
    print("=== Smart Home Server (Gevent) ===")
    print("Uruchamianie serwera z gevent...")
    ...
    try:
        # Uruchom serwer SocketIO z gevent
        socketio.run(
            app, 
            debug=debug, 
            host=host, 
