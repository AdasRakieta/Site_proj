"""Encryption routes have been removed from the project."""

# Placeholder to avoid import errors if referenced inadvertently
from flask import Blueprint

encryption_bp = Blueprint('encryption_removed', __name__)
